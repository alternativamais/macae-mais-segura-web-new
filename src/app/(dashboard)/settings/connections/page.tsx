...
const connectionStatusTagMap = {
  connected: { label: "Connected", tone: "success" },
  "not-connected": { label: "Not Connected", tone: "neutral" },
} as const

function ConnectionStatusTag({ connected }: { connected: boolean }) {
  const tag = resolveDataTagDefinition(
    connected ? "connected" : "not-connected",
    connectionStatusTagMap,
    { label: "-", tone: "neutral" }
  )

  return <DataTag tone={tag.tone} className="ml-2">{tag.label}</DataTag>
}
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-medium">
                        Facebook
                        <ConnectionStatusTag connected={false} />
                      </div>
