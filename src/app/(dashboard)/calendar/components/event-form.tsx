...
export function EventForm({ event, open, onOpenChange, onSave, onDelete }: EventFormProps) {
  ...
  const eventTypes = [
    ...
    { value: "event", label: t("types.event"), color: "bg-green-500" },
    { value: "personal", label: t("types.personal"), color: "bg-pink-500" },
    { value: "task", label: t("types.task"), color: "bg-orange-500" },
    { value: "reminder", label: t("types.reminder"), color: "bg-purple-500" }
  ]

  const durationOptions = [
    { value: "15 min", label: t("durations.15_min") },
    { value: "30 min", label: t("durations.30_min") },
    { value: "45 min", label: t("durations.45_min") },
    { value: "1 hour", label: t("durations.1_hour") },
    { value: "1.5 hours", label: t("durations.1_5_hours") },
    { value: "2 hours", label: t("durations.2_hours") },
    { value: "3 hours", label: t("durations.3_hours") },
    { value: "All day", label: t("durations.all_day") }
  ]
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {event ? t("title_edit") : t("title_create")}
          </DialogTitle>
          <DialogDescription>
            {event ? t("description_edit") : t("description_create")}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-4 h-10">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="all-day" className="text-sm">{t("labels.all_day")}</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <Switch
                    id="reminder"
                  ...
                  />
                  <Label htmlFor="reminder" className="text-sm">{t("labels.reminder")}</Label>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input
                placeholder={t("placeholders.attendee")}
                value={newAttendee}
                onChange={(e) => setNewAttendee(e.target.value)}
                onKeyPress={(e) => e.key === "Enter" && addAttendee()}
              />
              <Button onClick={addAttendee} variant="outline" className="cursor-pointer">{t("buttons.add")}</Button>
            </div>
